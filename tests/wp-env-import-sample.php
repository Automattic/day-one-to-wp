...
if ( $using_default_zip ) {
	...
	day_one_importer_wp_env_assert( 26 === $entries_found, 'Fictional fixture parsed twenty-six entries.' );
	day_one_importer_wp_env_assert( 26 === $created, 'Fictional fixture created exactly twenty-six private posts.' );
} else {
