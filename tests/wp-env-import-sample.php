...
if ( $using_default_zip ) {
	...
	day_one_importer_wp_env_assert( 19 === $entries_found, 'Fictional fixture parsed nineteen entries.' );
	day_one_importer_wp_env_assert( 19 === $created, 'Fictional fixture created exactly nineteen private posts.' );
} else {
