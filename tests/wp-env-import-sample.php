...
if ( $using_default_zip ) {
	...
	day_one_importer_wp_env_assert( 21 === $entries_found, 'Fictional fixture parsed twenty-one entries.' );
	day_one_importer_wp_env_assert( 21 === $created, 'Fictional fixture created exactly twenty-one private posts.' );
} else {
...
day_one_importer_wp_env_assert( '7' === Day_One_Importer_Runner::IMPORT_SCHEMA_VERSION, 'Import schema version is 7 for video embeds (issue #57).' );
