...
if ( $using_default_zip ) {
	...
	day_one_importer_wp_env_assert( 25 === $entries_found, 'Fictional fixture parsed twenty-five entries.' );
	day_one_importer_wp_env_assert( 25 === $created, 'Fictional fixture created exactly twenty-five private posts.' );
} else {
