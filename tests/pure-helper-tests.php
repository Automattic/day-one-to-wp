...
assert_true( 7 === count( $fixture_entries ), 'Committed fictional fixture parses seven entries.' );
assert_true( 7 === $fixture_results->get_count( 'entries_found' ), 'Committed fictional fixture reports seven found entries.' );
...
assert_true( ! empty( $batch_index['done'] ) && 7 === $batch_job['entries_total'], 'Batch parser indexes fixture entries into a manifest.' );
...
assert_true( 7 === $bounded_job['entries_total'] && $bounded_batches > 3, 'Batch parser can complete fixture indexing across multiple bounded requests.' );
